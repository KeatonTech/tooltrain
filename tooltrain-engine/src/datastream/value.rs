...
impl ValueStream {
    pub(crate) fn new(initial: Option<TooltrainValue>) -> Self {
    ...
    pub fn snapshot(&self) -> Option<Arc<TooltrainValue>> {
        self.value.clone()
    }

    pub(crate) fn set(&mut self, value: TooltrainValue) -> Result<(), Error> {
